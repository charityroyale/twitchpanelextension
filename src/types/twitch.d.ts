...
export interface Extension {
	onAuthorized(cb: (auth: { token: string; userId: string; clientId: string; channelId: string }) => void): void
	...
	unlisten(event: string, cb: (target: string, contentType: string, message: string) => void): void
	rig: ExtensionRig
